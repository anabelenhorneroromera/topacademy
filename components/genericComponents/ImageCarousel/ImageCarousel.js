...
export default class ImageCarousel extends Component {
  ...
  constructor(props) {
    ...
    // ✅ nuevo: bind para abrir instagram
  ...
  mouseUpHandler(e) {
    ...
    const cardMarginRight = Number(
      window.getComputedStyle(this.learningTargetsContainer.children[0]).marginRight.replace("px", "")
    );
  ...
  // ✅ nuevo: abre instagram
  openInstagram() {
    window.open(
      "https://www.instagram.com/serrano_and_bretzel/",
      "_blank",
      "noopener,noreferrer"
    );
  }
